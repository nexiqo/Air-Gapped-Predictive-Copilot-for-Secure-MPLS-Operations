  ...
  return (
    <div className="bottom-strip">
      ...
      <div className="strip-item">
        ...
        <span className="strip-value status-text-critical">
          Critical: {networkSummary.alert_count?.critical || 0}
        </span>
        <span className="strip-value status-text-warning">
      ...
      <div className="strip-item">
        ...
        {networkSummary.eta_to_failure > 0 ? (
          <>
            <span className="strip-value">ETA: {networkSummary.eta_to_failure} minutes</span>
            <span className="strip-value">CONF: {(networkSummary.confidence * 100).toFixed(0)}%</span>
          </>
        ) : (
      ...
      <div className="strip-item">
        ...
        <span className="strip-value">{networkSummary.most_at_risk_branch}</span>
      </div>
